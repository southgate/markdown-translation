From: https://github.com/facebook/chef-cookbooks/edit/master/CONTRIBUTING.md

# Contributing to Facebook's Chef Cookbooks

## Test Markdown

Here's a ~~couple~~ few GitHub-flavored Markdown tests from @southgate.

:tada: | :ok_hand: | :frowning: |
---------|----------|----------|
Huge congrats  | Less congratulations | No Congratulations
